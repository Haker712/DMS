...
public class BlueToothService {
	...
	public void ConnectToDevice(String address) {
		Log.e("In Connect to Device", address+"");
	...
	public synchronized void connect(BluetoothDevice device) {
		Log.e("In Connect", device.toString()+"");
		...
		Log.e("Before start thread", "HAHAH");
	...
	private class AcceptThread extends Thread {
		...
		public void run() {
			...
			while (mState != PrinterClass.STATE_CONNECTED) {
				try {
	...
	private class ConnectThread extends Thread {
		...
		public void run() {
			...
			try {
				...
				Log.e("Chk socket", mmSocket.toString()+"");
				mmSocket.connect();
				Log.e("After socket connect","###");
				connectionSuccess();
			} catch (IOException e) {
				e.printStackTrace();
				connectionFailed();
