...
//				Log.e("CCC", PrintActivity.pl.toString()+"ZZZ");
				...
				Log.e("DEVICE LIST", deviceList.size()+"SIZE");
				Log.e("CHC", "CJ");
				InitListView();
			}
		});
						...
						public void run() {
							...
							if (PrintActivity.pl != null) {
								if (PrintActivity.pl.getState() == PrinterClass.STATE_CONNECTED) {
									...
									PrintInvoiceActivity.checkState=true;
									tvFlag=false;
    ...
    //	Log.e("Device List Size", listData.size()+"####");
    	return listData;
    }
	...
	new AlertDialog.Builder(this).setTitle(getResources().getString(R.string.str_exit))
		...
		.setPositiveButton("YES", new DialogInterface.OnClickListener() {
		    ...
		    public void onClick(DialogInterface dialog, int which) {
		    	startActivity(new Intent(PrintSettingActivity.this, PrintInvoiceActivity.class));
				finish();
		    }
		})
